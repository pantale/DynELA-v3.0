...
# Creates the Nodes
dynELA.createNode(1, 0.00, 0.00, 00.0)
dynELA.createNode(2, 10.0, 0.00, 00.0)
dynELA.createNode(3, 10.0, 10.0, 00.0)
dynELA.createNode(4, 0.00, 10.0, 00.0)
dynELA.createNode(5, 0.00, 0.00, 10.0)
dynELA.createNode(6, 10.0, 0.00, 10.0)
dynELA.createNode(7, 10.0, 10.0, 10.0)
dynELA.createNode(8, 0.00, 10.0, 10.0)
print("Number of nodes created:", dynELA.getNodesNumber())

# Creates the Elements
dynELA.setDefaultElement(dnl.Element.ElHex8N3D)
dynELA.createElement(1, 1, 2, 3, 4, 5, 6, 7, 8)
print("Number of elements created:", dynELA.getElementsNumber())

# Creates the Groups
allNS=dnl.NodeSet("NS_All")
dynELA.add(allNS, 1, 8)

rightNS=dnl.NodeSet("NS_right")
dynELA.add(rightNS, 2, 3)
dynELA.add(rightNS, 6, 7)
