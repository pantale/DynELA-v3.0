...
public:
  ...
  ListIndex<Element *> elements; //!< Element list. This pointer reference the list of the elements that contains a reference to the current node (ie: the list of the elements that includes this node).
